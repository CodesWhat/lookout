...
portwing_build_info{version="0.9.17"} 1
...
```json
{"status":"ok","live":true,"ready":false,"mode":"standard","version":"0.9.17","uptimeSeconds":3842.7,"docker":"unknown","controller":"not_applicable"}
```
...
```json
{"status":"healthy","live":true,"ready":true,"mode":"standard","version":"0.9.17","uptimeSeconds":3842.7,"docker":"connected","controller":"not_applicable"}
```

Edge-mode not-ready response:

```json
{"status":"unhealthy","live":true,"ready":false,"mode":"edge","version":"0.9.17","uptimeSeconds":42.1,"docker":"connected","controller":"disconnected"}
```
